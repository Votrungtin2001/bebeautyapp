                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ListTile(
                                ...
                                trailing: Icon(Icons.location_on_outlined,size: 30,color: kPrimaryColor,),
                              ),
                            ],
                          ),
                        ),
                      ...
                      Card(
                        ...
                        child: FlatButton(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text("    Add new address",style: TextStyle(fontSize: 14, fontFamily: 'Poppins',color: kTextColor),),
                              Spacer(),
                              Padding(
